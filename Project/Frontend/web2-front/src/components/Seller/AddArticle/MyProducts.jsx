...
const MyProducts = () => {
  ...
  return (
    <div>
      {openAddProduct && <AddProductForm updateProducts={updateProducts} setOpen={setOpenAddProduct} />} 
      <UpdateProductForm open={open} setOpen={setOpen} data={data} setData={setData} updateProducts={updateProducts} />
